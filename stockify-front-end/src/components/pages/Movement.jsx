...
const Movements = () => {
    ...
    // --- 💡 CORRECCIÓN AQUÍ ---
    // Ajustamos esta función para que sea igual a la de tu Home.js
    const handleShowModal = () => {
        let initialBranchId = '';
        // Si el usuario es un empleado, su sucursal se asigna por defecto.
        ...
        setNewMovementData({
            movement_type: '',
            product: '',
            branch: initialBranchId, // Asignamos la sucursal por defecto
            quantity: '',
            description: ''
        });
        setShowModal(true);
    ...
    const availableProducts = useMemo(() => {
        ...
        if (!employeeBranchId || !movementType) {
            return [];
        }
                    ...
                    <Form>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Select name="product" value={newMovementData.product} onChange={handleFormChange} disabled={!newMovementData.movement_type && isEmployee}>
                                <option value="">
                                    {!newMovementData.movement_type && isEmployee
